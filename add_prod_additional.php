...
<form action="add_prod_ins_additional.php" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-content">
            ...
            <div class="modal-right">
                ...
                <div class="input-container">
                    ...
                    <input type="radio" id="additional" name="food" class="radio_btn" value="Additional" required checked>
