...
<form action="add_prod_ins_silog.php" method="post" enctype="multipart/form-data">
    <div id="add-product_modal" class="add_product">
        <div class="modal-content">
            ...
            <div class="modal-right">
                ...
                <div class="input-container">
                    <input type="radio" id="meal" name="food" class="radio_btn" value="Silog Meal" required checked>
