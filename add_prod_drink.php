...
<form action="add_prod_ins_drink.php" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-content">
            ...
            <div class="modal-right">
                ...
                <div class="input-container">
                    ...
                    <input type="radio" id="drink" name="food" class="radio_btn" value="Drink" required checked>
