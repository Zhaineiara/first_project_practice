...
<form action="add_prod_ins_snack.php" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-content">
            ...
            <div class="modal-right">
                ...
                <div class="input-container">
                    ...
                    <input type="radio" id="snack" name="food" class="radio_btn" value="Snack" required  checked>
